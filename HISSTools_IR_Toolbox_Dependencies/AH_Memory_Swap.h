...
static inline long alloc_mem_swap(t_safe_mem_swap *mem_struct, AH_UIntPtr size, AH_UIntPtr nom_size)
{
    long fail = 0;
...
static inline void *access_mem_swap(t_safe_mem_swap *mem_struct, AH_UIntPtr *nom_size)
{
    void *return_ptr;
...
static inline void schedule_swap_mem_swap(t_safe_mem_swap *mem_struct, void *ptr, AH_UIntPtr nom_size)
{
    t_atom method_ptr;
...
static inline void *schedule_grow_mem_swap(t_safe_mem_swap *mem_struct,  AH_UIntPtr size, AH_UIntPtr nom_size)
{
    t_atom method_ptr;
...
static inline void *schedule_equal_mem_swap(t_safe_mem_swap *mem_struct,  AH_UIntPtr size, AH_UIntPtr nom_size)
{
    t_atom method_ptr;
...
static inline void *grow_mem_swap(t_safe_mem_swap *mem_struct,  AH_UIntPtr size, AH_UIntPtr nom_size)
{
    t_atom method_ptr;
...
static inline long alloc_mem_swap_custom (t_safe_mem_swap *mem_struct, alloc_method alloc_method_ptr, free_method free_method_ptr, AH_UIntPtr size, AH_UIntPtr nom_size)
{
    long fail = 0;
...
static inline void *schedule_grow_mem_swap_custom (t_safe_mem_swap *mem_struct, alloc_method alloc_method_ptr, free_method free_method_ptr, AH_UIntPtr size, AH_UIntPtr nom_size)
{
    t_atom method_ptr;
...
static inline void *schedule_equal_mem_swap_custom (t_safe_mem_swap *mem_struct, alloc_method alloc_method_ptr, free_method free_method_ptr,  AH_UIntPtr size, AH_UIntPtr nom_size)
{
    t_atom method_ptr;
...
static inline void *grow_mem_swap_custom (t_safe_mem_swap *mem_struct, alloc_method alloc_method_ptr, free_method free_method_ptr, AH_UIntPtr size, AH_UIntPtr nom_size)
{
    t_atom method_ptr;
