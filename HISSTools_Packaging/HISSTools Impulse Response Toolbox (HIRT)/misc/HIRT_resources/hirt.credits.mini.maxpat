...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 88.0, 306.666672000000062, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 306.666672000000062, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.0, 306.666672000000062, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 287.0, 86.0, 65.0, 35.5 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 60.0, 60.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
,
					"patching_rect" : [ 60.0, 99.5, 77.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 287.0, 371.0, 51.0, 22.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 287.0, 304.0, 212.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 118.0, 291.416672000000062, 140.0, 60.5 ],
					"pictures" : [ "HIRT_HISSTools_Trace.svg", "HIRT_HISSTools_Trace.svg" ],
					"presentation" : 1,
					"presentation_rect" : [ 220.0, 1.5, 98.0, 52.25 ],
					"remapsvgcolors" : 1,
