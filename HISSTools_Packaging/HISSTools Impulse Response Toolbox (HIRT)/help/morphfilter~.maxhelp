...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 359.0, 165.0, 68.0, 23.0 ],
					"text" : "closebang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.0, 245.0, 157.0, 23.0 ],
					"text" : "s globalclose_mp_helpfile"
				}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 34.0, 121.0, 211.0, 23.0 ],
													"text" : "zl.reg morphfilter.convolutionreverb"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 306.439453000000015, 378.261719000000028, 68.0, 23.0 ],
									"text" : "closebang"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 446.0, 129.0, 42.0, 20.0 ],
									"rounded" : 20.0,
									"text" : "reset",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 176.0, 130.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "2",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 182.0, 129.0, 222.0, 21.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 619.0, 441.5, 62.0, 23.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-28", 0 ],
									"hidden" : 1,
									"midpoints" : [ 628.5, 472.5, 402.5, 472.5 ],
									"source" : [ "obj-4", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 270.007965087890625, 57.599853515625 ]
				}
...
,
		...
		"parameters" : 		{
			...
			"obj-7::obj-6::obj-1" : [ "live.text[4]", "live.text", 0 ],
			"obj-8::obj-6::obj-1" : [ "live.text[3]", "live.text", 0 ],
			"parameterbanks" : 			{
