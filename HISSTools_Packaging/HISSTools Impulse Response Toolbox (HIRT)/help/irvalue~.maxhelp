...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 369.0, 85.0, 168.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"textcolor" : [ 0.657440163565426, 0.0, 0.010957336059424, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 231.0, 158.0, 60.0, 23.0 ],
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 231.0, 130.0, 88.0, 23.0 ],
									"text" : "loadmess 69."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 124.0, 223.0, 79.0, 23.0 ],
									"text" : "prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 124.0, 171.0, 50.0, 23.0 ],
									"text" : "ftom 0."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 333.0, 526.0, 372.0, 128.0 ],
									"setminmax" : [ -40.0, 40.0 ],
									"slidercolor" : [ 0.658823529411765, 0.0, 0.011764705882353, 1.0 ],
									"thickness" : 1
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 64.0, 503.0, 94.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 237.5, 330.5, 125.0, 38.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 237.5, 393.0, 125.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 205.0, 198.0, 50.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 365.0, 448.0, 178.0, 23.0 ],
									"text_width" : 83.0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 179.0, 448.0, 109.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 64.0, 393.0, 94.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 64.0, 448.0, 43.0, 23.0 ],
									"text" : "dbtoa"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 64.0, 253.0, 94.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 64.0, 143.0, 56.0, 23.0 ],
									"varname" : "number"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 64.0, 198.0, 36.0, 23.0 ],
									"text" : "mtof"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 205.0, 253.0, 112.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 17.0, 392.0, 45.0, 25.0 ],
									"text" : "dB"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 17.0, 252.0, 45.0, 25.0 ],
									"text" : "Hz"
								}
...
, 							{
								"box" : 								{
									"amprange" : [ -40.0, 40.0 ],
									"color" : [ 0.0, 0.501960784313725, 0.0, 1.0 ],
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 13.0,
									...
									"ignoreclick" : 1,
									"linearmode" : 0,
									"markercolor" : [ 0.658823529411765, 0.0, 0.011764705882353, 1.0 ],
									"markers" : [ 277.182631080343526 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 259.5, 199.0, 157.5, 21.0 ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-27", 0 ],
									"midpoints" : [ 708.5, 244.0, 428.5, 244.0 ],
									"source" : [ "obj-22", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 1,
									"midpoints" : [ 73.5, 432.5, 342.5, 432.5 ],
									"order" : 0,
									"source" : [ "obj-23", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"hidden" : 1,
									"midpoints" : [ 346.25, 109.5, 346.25, 109.5 ],
									"source" : [ "obj-28", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-25", 0 ],
									"hidden" : 1,
									"midpoints" : [ 188.5, 486.5, 314.5, 486.5 ],
									"source" : [ "obj-29", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-25", 0 ],
									"midpoints" : [ 374.5, 486.5, 314.5, 486.5 ],
									"source" : [ "obj-32", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-33", 0 ],
									"hidden" : 1,
									"midpoints" : [ 247.0, 432.5, 342.5, 432.5 ],
									"source" : [ "obj-37", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-25", 0 ],
									"hidden" : 1,
									"midpoints" : [ 300.0, 488.5, 314.5, 488.5 ],
									"source" : [ "obj-39", 1 ]
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 173.3599853515625, 57.599853515625 ]
				}
...
,
					"patching_rect" : [ 138.375, 85.0, 45.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
		...
		"parameters" : 		{
			...
			"obj-6::obj-6::obj-1" : [ "live.text", "live.text", 0 ],
			"parameterbanks" : 			{
