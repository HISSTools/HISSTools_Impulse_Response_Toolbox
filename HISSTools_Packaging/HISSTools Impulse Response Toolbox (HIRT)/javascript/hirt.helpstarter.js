...
function init()
{
    ...
    if(a==null)
    {
		...
		this.patcher.wind.size= [809, 766];		// should be modified if we do not do top toolbar thing ??
...
//		basic.message("toptoolbarpinned", 2);	// no ??
		basic.message("toptoolbarpinned", 1);
